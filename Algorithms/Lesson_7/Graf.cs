...
namespace Lesson_7
{
    ...
    class Graf
    {
        ...
        /// <summary>
        /// Проверяем связанность между двумя вершинами в графе. Возвращает true, если связанность есть.
        /// </summary>
        /// <param name="firstVertice">Первая вершина</param>
        /// <param name="secondVertice">Вторая вершина</param>
        ...
        public bool CheckConnection(int firstVertice, int secondVertice)
        {
            ...
            Lesson_5.MyStack<int> stack = new Lesson_5.MyStack<int>(weightMatrix.GetLength(0)); 
